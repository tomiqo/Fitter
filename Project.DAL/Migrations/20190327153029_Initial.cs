    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersInTeam", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersInTeam_Team_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Team",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersInTeam_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersInTeam_TeamId",
                table: "UsersInTeam",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersInTeam_UserId",
                table: "UsersInTeam",
                column: "UserId");
        }
